...
export class Backend implements backendInterface {
    ...
    async addNote(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<bigint> {
    ...
    async addQuestion(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async isValidSubject(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isValidSubject(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateQuestion(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateQuestion(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
